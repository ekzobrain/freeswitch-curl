...
--
-- Table structure for table `dialplan_action`
--

CREATE TABLE IF NOT EXISTS `dialplan_action` (
...
INSERT INTO `dialplan_action` (`action_id`, `condition_id`, `application`, `data`, `anti_action`, `weight`) VALUES
(1, 2, 'deflect', '${destination_number}', FALSE, 10),
(2, 5, 'set', 'domain_name=$${domain}', FALSE, 20),
(3, 5, 'set', 'domain_name=${sip_auth_realm}', TRUE, 30),
(4, 7, 'set', 'domain_name=$${domain}', FALSE, 40),
(5, 9, 'set', 'open=true', FALSE, 50),
(6, 10, 'answer', '', FALSE, 60),
(7, 10, 'intercept', '${db(select/${domain_name}-last_dial/global)}', FALSE, 70),
(8, 10, 'sleep', '2000', FALSE, 80),
(9, 11, 'answer', '', FALSE, 90),
(10, 11, 'intercept', '${db(select/${domain_name}-last_dial/${callgroup})}', FALSE, 100),
(11, 11, 'sleep', '2000', FALSE, 110),
(12, 12, 'answer', '', FALSE, 120),
(13, 12, 'intercept', '${db(select/${domain_name}-last_dial_ext/$1)}', FALSE, 130),
(14, 12, 'sleep', '2000', FALSE, 140),
(15, 13, 'transfer', '${db(select/${domain_name}-last_dial/${caller_id_number})}', FALSE, 150),
(16, 14, 'set', 'use_profile=${cond(${acl($${local_ip_v4} rfc1918)} == true ? nat : default)}', FALSE, 160),
(17, 14, 'set', 'use_profile=${cond(${acl(${network_addr} rfc1918)} == true ? nat : default)}', TRUE, 170),
(18, 15, 'set_user', 'default@${domain_name}', FALSE, 180),
(19, 16, 'info', '', FALSE, 190),
(20, 17, 'set', 'sip_secure_media=true', FALSE, 200),
(21, 18, 'db', 'insert/${domain_name}-spymap/${caller_id_number}/${uuid}', FALSE, 210),
(22, 18, 'db', 'insert/${domain_name}-last_dial/${caller_id_number}/${destination_number}', FALSE, 220),
(23, 18, 'db', 'insert/${domain_name}-last_dial/global/${uuid}', FALSE, 230),
(24, 19, 'eval', '${snom_bind_key(2 off DND ${sip_from_user} ${sip_from_host} ${sofia_profile_name} message notused)}', FALSE, 240),
(25, 19, 'transfer', '3000', FALSE, 250),
(26, 20, 'eval', '${snom_bind_key(2 on DND ${sip_from_user} ${sip_from_host} ${sofia_profile_name} message api+uuid_transfer ${uuid} 9001)}', FALSE, 260),
(27, 20, 'playback', '$${hold_music}', FALSE, 270),
(28, 21, 'answer', '', FALSE, 280),
(29, 21, 'eavesdrop', '${db(select/${domain_name}-spymap/$1)}', FALSE, 290),
(30, 22, 'answer', '', FALSE, 300),
(31, 22, 'set', 'eavesdrop_indicate_failed=tone_stream://%(500, 0, 320)', FALSE, 310),
(32, 22, 'set', 'eavesdrop_indicate_new=tone_stream://%(500, 0, 620)', FALSE, 320),
(33, 22, 'set', 'eavesdrop_indicate_idle=tone_stream://%(250, 0, 920)', FALSE, 330),
(34, 22, 'eavesdrop', 'all', FALSE, 340),
(35, 23, 'transfer', '${db(select/${domain_name}-call_return/${caller_id_number})}', FALSE, 350),
(36, 24, 'answer', '', FALSE, 360),
(37, 24, 'group', 'delete:$1@${domain_name}:${sofia_contact(${sip_from_user}@${domain_name})}', FALSE, 370),
(38, 24, 'gentones', '%(1000, 0, 320)', FALSE, 380),
(39, 25, 'answer', '', FALSE, 390),
(40, 25, 'group', 'insert:$1@${domain_name}:${sofia_contact(${sip_from_user}@${domain_name})}', FALSE, 400),
(41, 25, 'gentones', '%(1000, 0, 640)', FALSE, 410),
(42, 26, 'bridge', '{ignore_early_media=true}${group(call:$1@${domain_name})}', FALSE, 420),
(43, 27, 'set', 'call_timeout=10', FALSE, 430),
(44, 27, 'bridge', '{ignore_early_media=true}${group(call:$1@${domain_name}:order)}', FALSE, 440),
(45, 28, 'set', 'dialed_extension=$1', FALSE, 450),
(46, 28, 'export', 'sip_auto_answer=true', FALSE, 460),
(47, 28, 'bridge', 'user/${dialed_extension}@${domain_name}', FALSE, 470),
(48, 29, 'set', 'dialed_extension=$1', FALSE, 480),
(49, 29, 'export', 'dialed_extension=$1', FALSE, 490),
(50, 30, 'set', 'voicemail_authorized=${sip_authorized}', FALSE, 500),
(51, 30, 'answer', '', FALSE, 510),
(52, 30, 'sleep', '1000', FALSE, 520),
(53, 30, 'voicemail', 'check default ${domain_name} ${dialed_extension}', FALSE, 530),
(54, 30, 'bind_meta_app', '1 b s execute_extension::dx XML features', TRUE, 540),
(55, 30, 'bind_meta_app', '2 b s record_session::$${recordings_dir}/${caller_id_number}.${strftime(%Y-%m-%d-%H-%M-%S)}.wav', TRUE, 550),
(56, 30, 'bind_meta_app', '3 b s execute_extension::cf XML features', TRUE, 560),
(57, 30, 'set', 'ringback=${us-ring}', TRUE, 570),
(58, 30, 'set', 'transfer_ringback=$${hold_music}', TRUE, 580),
(59, 30, 'set', 'call_timeout=30', TRUE, 590),
(60, 30, 'set', 'hangup_after_bridge=true', TRUE, 600),
(61, 30, 'set', 'continue_on_fail=true', TRUE, 610),
(62, 30, 'db', 'insert/${domain_name}-call_return/${dialed_extension}/${caller_id_number}', TRUE, 620),
(63, 30, 'db', 'insert/${domain_name}-last_dial_ext/${dialed_extension}/${uuid}', TRUE, 630),
(64, 30, 'set', 'called_party_callgroup=${user_data(${dialed_extension}@${domain_name} var callgroup)}', TRUE, 640),
(65, 30, 'db', 'insert/${domain_name}-last_dial/${called_party_callgroup}/${uuid}', TRUE, 650),
(66, 30, 'bridge', 'user/${dialed_extension}@${domain_name}', TRUE, 660),
(67, 30, 'answer', '', TRUE, 670),
(68, 30, 'sleep', '1000', TRUE, 680),
(69, 30, 'voicemail', 'default ${domain_name} ${dialed_extension}', TRUE, 690),
(70, 31, 'bridge', '${group_call(sales@${domain_name})}', FALSE, 700),
(71, 32, 'bridge', 'group/support@${domain_name}', FALSE, 710),
(72, 33, 'bridge', 'group/billing@${domain_name}', FALSE, 720),
(73, 34, 'set', 'transfer_ringback=$${hold_music}', FALSE, 730),
(74, 34, 'transfer', '1000 XML features', FALSE, 740),
(75, 35, 'answer', '', FALSE, 750),
(76, 35, 'sleep', '1000', FALSE, 760),
(77, 35, 'voicemail', 'check default ${domain_name}', FALSE, 770),
(78, 36, 'bridge', 'sofia/${use_profile}/$1', FALSE, 780),
(79, 37, 'answer', '', FALSE, 790),
(80, 37, 'conference', '$1-${domain_name}@default', FALSE, 800),
(81, 38, 'answer', '', FALSE, 810),
(82, 38, 'conference', '$1-${domain_name}@wideband', FALSE, 820),
(83, 39, 'answer', '', FALSE, 830),
(84, 39, 'conference', '$1-${domain_name}@ultrawideband', FALSE, 840),
(85, 40, 'answer', '', FALSE, 850),
(86, 40, 'conference', '$1-${domain_name}@cdquality', FALSE, 860),
(87, 41, 'bridge', 'sofia/${use_profile}/$1@conference.freeswitch.org', FALSE, 870),
(88, 42, 'set', 'conference_auto_outcall_caller_id_name=Mad Boss1', FALSE, 880),
(89, 42, 'set', 'conference_auto_outcall_caller_id_number=0911', FALSE, 890),
(90, 42, 'set', 'conference_auto_outcall_timeout=60', FALSE, 900),
(91, 42, 'set', 'conference_auto_outcall_flags=mute', FALSE, 910),
(92, 42, 'set', 'conference_auto_outcall_prefix={sip_auto_answer=true,execute_on_answer=''bind_meta_app 2 a s1 intercept::${uuid}''}', FALSE, 920),
(93, 42, 'set', 'sip_exclude_contact=${network_addr}', FALSE, 930),
(94, 42, 'conference_set_auto_outcall', '${group_call(sales)}', FALSE, 940),
(95, 42, 'conference', 'madboss_intercom1@default+flags{endconf|deaf}', FALSE, 950),
(96, 43, 'set', 'conference_auto_outcall_caller_id_name=Mad Boss2', FALSE, 960),
(97, 43, 'set', 'conference_auto_outcall_caller_id_number=0912', FALSE, 970),
(98, 43, 'set', 'conference_auto_outcall_timeout=60', FALSE, 980),
(99, 43, 'set', 'conference_auto_outcall_flags=mute', FALSE, 990),
(100, 43, 'set', 'conference_auto_outcall_prefix={sip_auto_answer=true,execute_on_answer=''bind_meta_app 2 a s1 intercept::${uuid}''}', FALSE, 1000),
(101, 43, 'set', 'sip_exclude_contact=${network_addr}', FALSE, 1010),
(102, 43, 'conference_set_auto_outcall', 'loopback/9999', FALSE, 1020),
(103, 43, 'conference', 'madboss_intercom2@default+flags{endconf|deaf}', FALSE, 1030),
(104, 44, 'set', 'conference_auto_outcall_caller_id_name=Mad Boss', FALSE, 1040),
(105, 44, 'set', 'conference_auto_outcall_caller_id_number=0911', FALSE, 1050),
(106, 44, 'set', 'conference_auto_outcall_timeout=60', FALSE, 1060),
(107, 44, 'set', 'conference_auto_outcall_flags=none', FALSE, 1070),
(108, 44, 'conference_set_auto_outcall', 'loopback/9999', FALSE, 1080),
(109, 44, 'conference', 'madboss3@default', FALSE, 1090),
(110, 45, 'answer', '', FALSE, 1100),
(111, 45, 'sleep', '2000', FALSE, 1110),
(112, 45, 'ivr', 'demo_ivr', FALSE, 1120),
(113, 46, 'conference', 'bridge:mydynaconf:sofia/${use_profile}/1234@conference.freeswitch.org', FALSE, 1130),
(114, 47, 'answer', '', FALSE, 1140),
(115, 47, 'esf_page_group', '', FALSE, 1150),
(116, 48, 'set', 'fifo_music=$${hold_music}', FALSE, 1160),
(117, 48, 'fifo', '5900@${domain_name} in', FALSE, 1170),
(118, 49, 'answer', '', FALSE, 1180),
(119, 49, 'fifo', '5900@${domain_name} out nowait', FALSE, 1190),
(120, 51, 'fifo', '$1@${domain_name} in undef $${hold_music}', FALSE, 1200),
(121, 54, 'answer', '', FALSE, 1210),
(122, 54, 'fifo', '$1@${domain_name} out nowait', FALSE, 1220),
(123, 57, '', '', 'expression', 1230),
(124, 57, 'fifo', '$1@${domain_name} in undef $${hold_music}', FALSE, 1240),
(125, 60, 'answer', '', FALSE, 1250),
(126, 60, 'fifo', '$1@${domain_name} out nowait', FALSE, 1260),
(127, 61, 'pre_answer', '', FALSE, 1270),
(128, 61, 'sleep', '20000', FALSE, 1280),
(129, 61, 'answer', '', FALSE, 1290),
(130, 61, 'sleep', '1000', FALSE, 1300),
(131, 61, 'playback', 'voicemail/vm-goodbye.wav', FALSE, 1310),
(132, 61, 'hangup', '', FALSE, 1320),
(133, 62, 'ring_ready', '', FALSE, 1330),
(134, 62, 'sleep', '20000', FALSE, 1340),
(135, 62, 'answer', '', FALSE, 1350),
(136, 62, 'sleep', '1000', FALSE, 1360),
(137, 62, 'playback', 'voicemail/vm-goodbye.wav', FALSE, 1370),
(138, 62, 'hangup', '', FALSE, 1380),
(139, 63, 'set', 'ringback=$${uk-ring}', FALSE, 1390),
(140, 63, 'bridge', 'loopback/wait', FALSE, 1400),
(141, 64, 'set', 'ringback=$${hold_music}', FALSE, 1410),
(142, 64, 'bridge', 'loopback/wait', FALSE, 1420),
(143, 65, 'set', 'transfer_ringback=$${uk-ring}', FALSE, 1430),
(144, 65, 'answer', '', FALSE, 1440),
(145, 65, 'bridge', 'loopback/wait', FALSE, 1450),
(146, 66, 'set', 'transfer_ringback=$${hold_music}', FALSE, 1460),
(147, 66, 'answer', '', FALSE, 1470),
(148, 66, 'bridge', 'loopback/wait', FALSE, 1480),
(149, 67, 'answer', '', FALSE, 1490),
(150, 67, 'info', '', FALSE, 1500),
(151, 67, 'sleep', '250', FALSE, 1510),
(152, 67, 'hangup', '', FALSE, 1520),
(153, 68, 'answer', '', FALSE, 1530),
(154, 68, 'record_fsv', '/tmp/testrecord.fsv', FALSE, 1540),
(155, 69, 'answer', '', FALSE, 1550),
(156, 69, 'play_fsv', '/tmp/testrecord.fsv', FALSE, 1560),
(157, 70, 'answer', '', FALSE, 1570),
(158, 70, 'delay_echo', '5000', FALSE, 1580),
(159, 71, 'answer', '', FALSE, 1590),
(160, 71, 'echo', '', FALSE, 1600),
(161, 72, 'answer', '', FALSE, 1610),
(162, 72, 'playback', 'tone_stream://%(10000,0,1004);loops=-1', FALSE, 1620),
(163, 73, 'answer', '', FALSE, 1630),
(164, 73, 'playback', 'tone_stream://path=${base_dir}/conf/tetris.ttml;loops=10', FALSE, 1640),
(165, 75, 'answer', '', FALSE, 1650),
(166, 75, 'execute_extension', 'is_secure XML features', FALSE, 1660),
(167, 75, 'playback', '$${hold_music}', FALSE, 1670),
(168, 75, 'answer', '', TRUE, 1680),
(169, 75, 'playback', '$${hold_music}', TRUE, 1690);
