...
--
-- Name: dialplan_action; Type: TABLE; Schema: public; Owner: freeswitch; Tablespace:
--
...
CREATE TABLE dialplan_action (
    ...
    data character varying(256) DEFAULT NULL,
...
--ALTER TABLE public.dialplan_action OWNER TO freeswitch;
...
ALTER SEQUENCE dialplan_actions_action_id_seq OWNED BY dialplan_action.action_id;


--
-- Name: dialplan_condition; Type: TABLE; Schema: public; Owner: freeswitch; Tablespace:
--
CREATE TYPE dialplan_condition_break AS ENUM ('on-true', 'on-false', 'never');

CREATE TABLE dialplan_condition (
    condition_id integer NOT NULL,
    extension_id integer NOT NULL,
    field character varying(128) DEFAULT NULL,
    expression character varying(128) DEFAULT NULL,
...
ALTER TABLE ONLY dialplan_action ALTER COLUMN action_id SET DEFAULT nextval('dialplan_actions_action_id_seq'::regclass);
...
ALTER TABLE ONLY dialplan_action
...
--
-- Name: directory_domain_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: freeswitch
--
