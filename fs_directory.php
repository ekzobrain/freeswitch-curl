...
class fs_directory extends fs_curl
{
    ...
    private function get_domains($domain = NULL)
    {
        $where = '';
        if ($domain) {
    ...
    private function get_directory($domain)
    {
        ...
        if (null === $this->userid || $this->userid == false) {
     ...
     * @param array $domain
     */
    private function write_global_params($domain)
    {
     ...
     * @param array $domain
     */
    private function write_global_vars($domain)
    {
